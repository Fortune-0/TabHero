...
function updateSliderValues() {
    document.getElementById('inactiveTimeoutValue').textContent = document.getElementById('inactiveTimeoutValue').value;
    document.getElementById('sleepTimeoutValue').textContent = document.getElementById('sleepTimeoutValue').value;
    document.getElementById('closeTimeoutValue').textContent = document.getElementById('closeTimeoutValue').value;
}
